...
- peut être montrer des captures d'écrans de la partie en elle-même
- ajouter des références dans la partie réservée

# Propositions d'amélioration du jeu

- mettre un peu plus d'info sur les cartes (plus de description)
- ajouter quelque chose pour indiquer c'est à qui de jouer
- peut être rajouter les dates une fois que les cartes ont été posées
- afficher le numero actuel
- mettre une limite de temps de jeu par personne
- message pour savoir si la carte que l'on a mis est au bon endroit ou pas
...
Justifications : les commits sont tous légendés, il y a actuellement 173 commits (12h04). Je vois des commits de la part de tout le monde. Les fichiers sont clairement organisés.
...
Résumer en une phrase ce que vous avez éventuellement appris : J'ai été étonné par certaines réponses donc j'ai regardé le resultat. 

Autres justifications : Malheureusement, sans avoir les dates au résultat c'est pas facile de se rappeler.
